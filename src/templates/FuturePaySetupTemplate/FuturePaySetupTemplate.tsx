...
const FuturePaySetupTemplate = ({
  ...
  // Future payment always has a single statement.
  ...
  const handleSubmit = (e: any) => {
    ...
    if (currentUrl.includes("/ui/v8")) {
      window.location.href = FUTURE_PAYMENT_SETUP_MOP_PROTOTYPE;
    } else {
      const host = window.location.origin;
      axiosAPI({
        url: `${host}${FUTURE_PAYMENT_SETUP_URL}`,
        method: "POST",
        headers: {
  ...
  return (
    <>
      ...
      <div id="future-payment-setup-container">
        ...
        {!payment?.noStmtAvailable?.noStmtAvailable && statement && (
          <form
            className="future-payment-setup-form"
            action=""
            ...
            <div>
              ...
              <div className="statement-details-container">
                ...
                <div className="radio-group-container">
                  ...
                  {/* OTHER AMOUNT — focuses the input auto-selects this option */}
                  <div>
                    <div
                    ...
                    >
                      ...
                      <div className="other-amount-input-container">
                        ...
                        {inputError && (
                          <FormMessage
                            id={`future-pay-other-amount-${statement.id}`}
